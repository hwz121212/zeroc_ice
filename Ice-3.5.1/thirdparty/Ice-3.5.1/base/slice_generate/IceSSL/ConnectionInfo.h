...
#ifndef __IceSSL____slice_generate_IceSSL_ConnectionInfo_h__
#define __IceSSL____slice_generate_IceSSL_ConnectionInfo_h__
...
bool operator<(const ConnectionInfo&, const ConnectionInfo&);
::Ice::LocalObject* upCast(::IceSSL::ConnectionInfo*);
...
class ConnectionInfo : public ::Ice::IPConnectionInfo
{
public:
