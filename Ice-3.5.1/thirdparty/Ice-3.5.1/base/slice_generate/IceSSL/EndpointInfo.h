...
#ifndef __IceSSL____slice_generate_IceSSL_EndpointInfo_h__
#define __IceSSL____slice_generate_IceSSL_EndpointInfo_h__
...
bool operator<(const EndpointInfo&, const EndpointInfo&);
::Ice::LocalObject* upCast(::IceSSL::EndpointInfo*);
...
class EndpointInfo : public ::Ice::IPEndpointInfo
{
public:
