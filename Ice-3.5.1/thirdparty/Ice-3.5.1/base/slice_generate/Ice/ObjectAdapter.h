...
#ifndef __Ice____slice_generate_Ice_ObjectAdapter_h__
#define __Ice____slice_generate_Ice_ObjectAdapter_h__
...
class ObjectAdapter : virtual public ::Ice::LocalObject
{
public:
