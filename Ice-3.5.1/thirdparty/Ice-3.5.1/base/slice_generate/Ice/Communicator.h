...
#ifndef __Ice____slice_generate_Ice_Communicator_h__
#define __Ice____slice_generate_Ice_Communicator_h__
...
bool operator<(const Communicator&, const Communicator&);
::Ice::LocalObject* upCast(::Ice::Communicator*);
...
class Communicator : virtual public ::Ice::LocalObject
{
public:
