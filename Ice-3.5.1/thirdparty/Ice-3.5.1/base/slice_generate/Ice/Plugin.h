...
#ifndef __Ice____slice_generate_Ice_Plugin_h__
#define __Ice____slice_generate_Ice_Plugin_h__
...
class Plugin : virtual public ::Ice::LocalObject
{
public:
...
class PluginManager : virtual public ::Ice::LocalObject
{
public:
