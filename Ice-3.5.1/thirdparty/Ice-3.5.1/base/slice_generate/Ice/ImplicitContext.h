...
#ifndef __Ice____slice_generate_Ice_ImplicitContext_h__
#define __Ice____slice_generate_Ice_ImplicitContext_h__
...
bool operator<(const ImplicitContext&, const ImplicitContext&);
::Ice::LocalObject* upCast(::Ice::ImplicitContext*);
...
class ImplicitContext : virtual public ::Ice::LocalObject
{
public:
