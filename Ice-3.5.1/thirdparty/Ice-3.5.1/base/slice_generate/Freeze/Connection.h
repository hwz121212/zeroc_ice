...
#ifndef __Freeze____slice_generate_Freeze_Connection_h__
#define __Freeze____slice_generate_Freeze_Connection_h__
...
class TransactionAlreadyInProgressException : public ::Ice::LocalException
{
public:
