...
#ifndef __Freeze____slice_generate_Freeze_Evictor_h__
#define __Freeze____slice_generate_Freeze_Evictor_h__
...
class NoSuchElementException : public ::Ice::LocalException
{
public:
...
class EvictorDeactivatedException : public ::Ice::LocalException
{
public:
...
class ServantInitializer : virtual public ::Ice::LocalObject
{
public:
...
class EvictorIterator : virtual public ::Ice::LocalObject
{
public:
...
class Evictor : virtual public ::Ice::ServantLocator
{
public:
