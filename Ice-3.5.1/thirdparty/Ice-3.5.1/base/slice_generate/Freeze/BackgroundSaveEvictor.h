...
#ifndef __Freeze____slice_generate_Freeze_BackgroundSaveEvictor_h__
#define __Freeze____slice_generate_Freeze_BackgroundSaveEvictor_h__
...
class BackgroundSaveEvictor : virtual public ::Freeze::Evictor
{
public:
