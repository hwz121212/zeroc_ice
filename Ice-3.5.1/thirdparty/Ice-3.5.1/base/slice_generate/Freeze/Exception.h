...
#ifndef __Freeze____slice_generate_Freeze_Exception_h__
#define __Freeze____slice_generate_Freeze_Exception_h__
...
bool operator<(const Transaction&, const Transaction&);
::Ice::LocalObject* upCast(::Freeze::Transaction*);
...
class DatabaseException : public ::Ice::LocalException
{
public:
...
class NotFoundException : public ::Freeze::DatabaseException
{
public:
...
class DeadlockException : public ::Freeze::DatabaseException
{
public:
...
class InvalidPositionException : public ::Ice::LocalException
{
public:
...
class IndexNotFoundException : public ::Ice::LocalException
{
public:
