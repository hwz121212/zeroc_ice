...
class AMDCallback : virtual public Ice::LocalObject
{
public:
...
//
class IncomingAsync : public IncomingBase, virtual public Ice::AMDCallback
{
public:
...
class AMD_Object_ice_invoke : virtual public Ice::AMDCallback
{
public:
...
class AMD_Object_ice_invoke : public ::Ice::AMD_Object_ice_invoke, public IceInternal::IncomingAsync
{
public:
