...
class BlobjectArray : virtual public Object
{
public:
...
class BlobjectArrayAsync : virtual public Object
{
public:
...
void ice_writeObject(const OutputStreamPtr&, const ObjectPtr&);
void ice_readObject(const InputStreamPtr&, ObjectPtr&);
