...
private:
    ...
    friend CommunicatorPtr initialize(int&, char*[], const InitializationData&, Int);
    friend CommunicatorPtr initialize(StringSeq&, const InitializationData&, Int);
    friend CommunicatorPtr initialize(const InitializationData&, Int);
    friend ::IceInternal::InstancePtr IceInternal::getInstance(const ::Ice::CommunicatorPtr&);
