...
void throwMemoryLimitException(const char*, int, size_t, size_t);
void throwMarshalException(const char*, int, const std::string&);
...
class SystemException : public IceUtil::Exception
{
public:
