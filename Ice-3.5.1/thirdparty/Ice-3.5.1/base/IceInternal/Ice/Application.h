...
{
    extern IceUtil::Mutex* mutex;
    extern IceUtil::Cond* _condVar;

    //
    // Variables than can change while run() and communicator->destroy() are running!
    //
    extern bool _callbackInProgress;
    extern bool _destroyed;
    extern bool _interrupted;
    ...
    extern Ice::CommunicatorPtr _communicator;
    extern Ice::SignalPolicy _signalPolicy;
    extern Ice::Application* _application;
}
...
class Application : private IceUtil::noncopyable
{
public:
