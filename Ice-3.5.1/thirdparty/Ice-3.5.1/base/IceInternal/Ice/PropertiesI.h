...
private:
    ...
    friend PropertiesPtr createProperties(const StringConverterPtr&);
    friend PropertiesPtr createProperties(StringSeq&, const PropertiesPtr&, const StringConverterPtr&);
    friend PropertiesPtr createProperties(int&, char*[], const PropertiesPtr&, const StringConverterPtr&);
