...
//
class OutgoingAsyncMessageCallback : virtual public IceUtil::Shared
{
public:
...
class OutgoingAsync : public OutgoingAsyncMessageCallback, public Ice::AsyncResult, private IceUtil::TimerTask
{
public:
...
class BatchOutgoingAsync : public OutgoingAsyncMessageCallback, public Ice::AsyncResult
{
public:
...
class ProxyBatchOutgoingAsync : public BatchOutgoingAsync
{
public:
...
class ConnectionBatchOutgoingAsync : public BatchOutgoingAsync
{
public:
...
class CommunicatorBatchOutgoingAsync : public Ice::AsyncResult
{
public:
...
//
class CallbackBase : public IceUtil::Shared
{
public:
...
//
class GenericCallbackBase : virtual public CallbackBase
{
};
...
class AMICallbackBase : virtual public IceUtil::Shared
{
public:
