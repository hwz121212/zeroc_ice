...
class Router;
::IceProxy::Ice::Object* upCast(::IceProxy::Ice::Router*);
...
void ice_writeObjectPrx(const ::Ice::OutputStreamPtr&, const ObjectPrx&);
void ice_readObjectPrx(const ::Ice::InputStreamPtr&, ObjectPrx&);
...
class AMI_Object_ice_invoke : public Ice::AMICallbackBase
{
public:
...
class AMI_Array_Object_ice_invoke : public Ice::AMICallbackBase
{
public:
...
class AMI_Object_ice_flushBatchRequests : public Ice::AMICallbackBase
{
public:
...
class Cpp11FnCallbackNC : virtual public CallbackBase
{
public:
...
class Cpp11FnOnewayCallbackNC : virtual public ::IceInternal::Cpp11FnCallbackNC
{
public:
...
class Object : public ::IceUtil::Shared
{
public:
...
class Object : virtual public ::IceDelegate::Ice::Object
{
public:
...
// Helper with type ID.
//
::Ice::ObjectPrx checkedCastImpl(const ::Ice::ObjectPrx&, const std::string&, const std::string&,
                                         const ::Ice::Context*);
