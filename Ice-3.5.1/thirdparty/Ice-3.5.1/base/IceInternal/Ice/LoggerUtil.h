...
class LoggerOutputBase : private IceUtil::noncopyable
{
public:
...
LoggerOutputBase& operator<<(LoggerOutputBase&, std::ios_base& (*)(std::ios_base&));
LoggerOutputBase& operator<<(LoggerOutputBase&, const ::std::exception& ex);
...
class Trace : public LoggerOutputBase
{
public:
...
//
class LoggerPlugin : public Ice::Plugin
{
public:
