...
class APIException : public IceUtil::Exception
{
public:
...
::std::ostream& operator<<(::std::ostream&, const APIException&);

class BadOptException : public IceUtil::Exception
{
public:
...
::std::ostream& operator<<(::std::ostream&, const BadOptException&);
