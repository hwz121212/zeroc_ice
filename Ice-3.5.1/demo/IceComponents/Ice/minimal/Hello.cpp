...
IceProxy::Demo::Hello::begin_sayHello(const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
    ...
    try
    {
        __result->__prepare(__Demo__Hello__sayHello_name, ::Ice::Normal, __ctx);
...
{
    ::IceInternal::Outgoing __og(__handler.get(), __Demo__Hello__sayHello_name, ::Ice::Normal, __context, __observer);
...
IceDelegateD::Demo::Hello::sayHello(const ::Ice::Context* __context, ::IceInternal::InvocationObserver&)
{
    ...
    __initCurrent(__current, __Demo__Hello__sayHello_name, ::Ice::Normal, __context);
    try
    {
