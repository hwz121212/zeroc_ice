...
class Ping;
void __read(::IceInternal::BasicStream*, ::IceInternal::ProxyHandle< ::IceProxy::Demo::Ping>&);
...
void __patch(PingPtr&, const ::Ice::ObjectPtr&);
...
public:
    ...
    ::IceInternal::ProxyHandle<Ping> ice_endpoints(const ::Ice::EndpointSeq& __endpoints) const
    {
        return dynamic_cast<Ping*>(::IceProxy::Ice::Object::ice_endpoints(__endpoints).get());
    }
    
    ::IceInternal::ProxyHandle<Ping> ice_locatorCacheTimeout(int __timeout) const
    {
        return dynamic_cast<Ping*>(::IceProxy::Ice::Object::ice_locatorCacheTimeout(__timeout).get());
    }
    
    ::IceInternal::ProxyHandle<Ping> ice_connectionCached(bool __cached) const
    {
        return dynamic_cast<Ping*>(::IceProxy::Ice::Object::ice_connectionCached(__cached).get());
    }
    
    ::IceInternal::ProxyHandle<Ping> ice_endpointSelection(::Ice::EndpointSelectionType __est) const
    {
        return dynamic_cast<Ping*>(::IceProxy::Ice::Object::ice_endpointSelection(__est).get());
    }
    ...
    ::IceInternal::ProxyHandle<Ping> ice_preferSecure(bool __preferSecure) const
    {
        return dynamic_cast<Ping*>(::IceProxy::Ice::Object::ice_preferSecure(__preferSecure).get());
    }
    ...
    ::IceInternal::ProxyHandle<Ping> ice_collocationOptimized(bool __co) const
    {
        return dynamic_cast<Ping*>(::IceProxy::Ice::Object::ice_collocationOptimized(__co).get());
    }
    ...
    ::IceInternal::ProxyHandle<Ping> ice_compress(bool __compress) const
    {
        return dynamic_cast<Ping*>(::IceProxy::Ice::Object::ice_compress(__compress).get());
    }
    ...
    ::IceInternal::ProxyHandle<Ping> ice_connectionId(const ::std::string& __id) const
    {
        return dynamic_cast<Ping*>(::IceProxy::Ice::Object::ice_connectionId(__id).get());
    }
    
    ::IceInternal::ProxyHandle<Ping> ice_encodingVersion(const ::Ice::EncodingVersion& __v) const
    {
        return dynamic_cast<Ping*>(::IceProxy::Ice::Object::ice_encodingVersion(__v).get());
    }
...
protected:
    ...
    friend class Ping__staticInit;
};

class Ping__staticInit
{
public:
...
static Ping__staticInit _Ping_init;

inline bool operator==(const Ping& l, const Ping& r)
{
