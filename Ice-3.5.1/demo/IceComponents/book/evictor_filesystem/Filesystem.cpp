...
namespace
{
const int __Filesystem__Node_operationAttributes[] = 
{
    5, // destroy
    0, // ice_id
    0, // ice_ids
...
::Ice::Int
Filesystem::Node::ice_operationAttributes(const ::std::string& opName) const
{
    ::std::pair< const ::std::string*, const ::std::string*> r = ::std::equal_range(__Filesystem__Node_all, __Filesystem__Node_all + 6, opName);
    if(r.first == r.second)
    {
        return -1;
    }
    return __Filesystem__Node_operationAttributes[r.first - __Filesystem__Node_all];
}
...
namespace
{
const int __Filesystem__File_operationAttributes[] = 
{
    5, // destroy
    0, // ice_id
    0, // ice_ids
...
::Ice::Int
Filesystem::File::ice_operationAttributes(const ::std::string& opName) const
{
    ::std::pair< const ::std::string*, const ::std::string*> r = ::std::equal_range(__Filesystem__File_all, __Filesystem__File_all + 8, opName);
    if(r.first == r.second)
    {
        return -1;
    }
    return __Filesystem__File_operationAttributes[r.first - __Filesystem__File_all];
}
...
namespace
{
const int __Filesystem__Directory_operationAttributes[] = 
{
    5, // createDirectory
    5, // createFile
    5, // destroy
...
::Ice::Int
Filesystem::Directory::ice_operationAttributes(const ::std::string& opName) const
{
    ::std::pair< const ::std::string*, const ::std::string*> r = ::std::equal_range(__Filesystem__Directory_all, __Filesystem__Directory_all + 10, opName);
    if(r.first == r.second)
    {
        return -1;
    }
    return __Filesystem__Directory_operationAttributes[r.first - __Filesystem__Directory_all];
}
