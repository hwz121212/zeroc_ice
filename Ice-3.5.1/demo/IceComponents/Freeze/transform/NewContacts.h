...
#ifndef ____NewContacts_h__
#define ____NewContacts_h__

#include <Freeze/Map.h>
#include <NewContactData.h>
...
class NewContacts : public Freeze::Map< ::std::string, ::Demo::ContactData, NewContactsKeyCodec, NewContactsValueCodec, std::less< ::std::string> >
{
public:
    ...
    NewContacts(const Freeze::ConnectionPtr&, const std::string&, bool = true, const std::less< ::std::string>& = std::less< ::std::string>());

    template <class _InputIterator>
    NewContacts(const Freeze::ConnectionPtr& __connection, const std::string& __dbName, bool __createDb, _InputIterator __first, _InputIterator __last, const std::less< ::std::string>& __compare = std::less< ::std::string>())
    ...
    {
        Freeze::KeyCompareBasePtr __keyCompare = new Freeze::KeyCompare< ::std::string, NewContactsKeyCodec, std::less< ::std::string> >(__compare, this->_communicator, this->_encoding);
        std::vector<Freeze::MapIndexBasePtr> __indices;
        __indices.push_back(new PhoneNumberIndex("phoneNumber"));
        this->_helper.reset(Freeze::MapHelper::create(__connection, __dbName, NewContactsKeyCodec::typeId(), NewContactsValueCodec::typeId(), __keyCompare, __indices, __createDb));
