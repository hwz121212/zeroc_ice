...
class Callback_Hello_getGreeting_Base : virtual public ::IceInternal::CallbackBase { };
...
public:
    ...
    ::std::string getGreeting(const ::Ice::Context& __ctx)
    {
        return getGreeting(&__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_getGreeting(const ::IceInternal::Function<void (const ::std::string&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_getGreeting(0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_getGreeting(const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_getGreeting(0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_getGreeting(const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::std::string&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_getGreeting(&__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_getGreeting(const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_getGreeting(&__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_getGreeting(const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::std::string&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent)
    {
        ...
        public:
            ...
            virtual void __completed(const ::Ice::AsyncResultPtr& __result) const
            {
                ...
                try
                {
                    __ret = __proxy->end_getGreeting(__result);
                }
        ...
        return begin_getGreeting(__ctx, new Cpp11CB(__response, __exception, __sent));
    }
    
public:
#endif

    ::Ice::AsyncResultPtr begin_getGreeting()
    {
        return begin_getGreeting(0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_getGreeting(const ::Ice::Context& __ctx)
    {
        return begin_getGreeting(&__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_getGreeting(const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_getGreeting(0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_getGreeting(const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_getGreeting(&__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_getGreeting(const ::Demo::Callback_Hello_getGreetingPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_getGreeting(0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_getGreeting(const ::Ice::Context& __ctx, const ::Demo::Callback_Hello_getGreetingPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_getGreeting(&__ctx, __del, __cookie);
    }

    ::std::string end_getGreeting(const ::Ice::AsyncResultPtr&);
    
private:

    ::std::string getGreeting(const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_getGreeting(const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
public:
    ...
    virtual ::std::string getGreeting(const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;
...
public:
    ...
    virtual ::std::string getGreeting(const ::Ice::Context*, ::IceInternal::InvocationObserver&);
...
public:
    ...
    virtual ::std::string getGreeting(const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___getGreeting(::IceInternal::Incoming&, const ::Ice::Current&);
