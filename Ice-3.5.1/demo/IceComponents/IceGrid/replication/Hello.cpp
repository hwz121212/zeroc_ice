...
const ::std::string __Demo__Hello__getGreeting_name = "getGreeting";
...
::std::string
IceProxy::Demo::Hello::getGreeting(const ::Ice::Context* __ctx)
{
    ::IceInternal::InvocationObserver __observer(this, __Demo__Hello__getGreeting_name, __ctx);
    int __cnt = 0;
    while(true)
    {
        ...
        try
        {
            __checkTwowayOnly(__Demo__Hello__getGreeting_name);
            __delBase = __getDelegate(false);
            ::IceDelegate::Demo::Hello* __del = dynamic_cast< ::IceDelegate::Demo::Hello*>(__delBase.get());
            return __del->getGreeting(__ctx, __observer);
        }
...
::Ice::AsyncResultPtr
IceProxy::Demo::Hello::begin_getGreeting(const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
    __checkAsyncTwowayOnly(__Demo__Hello__getGreeting_name);
    ::IceInternal::OutgoingAsyncPtr __result = new ::IceInternal::OutgoingAsync(this, __Demo__Hello__getGreeting_name, __del, __cookie);
    try
    {
        __result->__prepare(__Demo__Hello__getGreeting_name, ::Ice::Idempotent, __ctx);
...
::std::string
IceProxy::Demo::Hello::end_getGreeting(const ::Ice::AsyncResultPtr& __result)
{
    ::Ice::AsyncResult::__check(__result, this, __Demo__Hello__getGreeting_name);
    ::std::string __ret;
...
::std::string
IceDelegateM::Demo::Hello::getGreeting(const ::Ice::Context* __context, ::IceInternal::InvocationObserver& __observer)
{
    ::IceInternal::Outgoing __og(__handler.get(), __Demo__Hello__getGreeting_name, ::Ice::Idempotent, __context, __observer);
...
::std::string
IceDelegateD::Demo::Hello::getGreeting(const ::Ice::Context* __context, ::IceInternal::InvocationObserver&)
{
    ...
    public:
        ...
        run(::Ice::Object* object)
        {
            ...
            _result = servant->getGreeting(_current);
    ...
    __initCurrent(__current, __Demo__Hello__getGreeting_name, ::Ice::Idempotent, __context);
    ::std::string __result;
    try
    {
...
::Ice::DispatchStatus
Demo::Hello::___getGreeting(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    __checkMode(::Ice::Idempotent, __current.mode);
    __inS.readEmptyParams();
    ::std::string __ret = getGreeting(__current);
...
Demo::Hello::__dispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ...
    switch(r.first - __Demo__Hello_all)
    {
        case 0:
        {
            return ___getGreeting(in, current);
        }
        case 1:
        {
