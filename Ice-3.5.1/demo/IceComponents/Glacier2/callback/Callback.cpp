...
const ::std::string __Demo__Callback__initiateCallback_name = "initiateCallback";

const ::std::string __Demo__Callback__shutdown_name = "shutdown";
...
void
IceProxy::Demo::Callback::initiateCallback(const ::Demo::CallbackReceiverPrx& proxy, const ::Ice::Context* __ctx)
{
    ::IceInternal::InvocationObserver __observer(this, __Demo__Callback__initiateCallback_name, __ctx);
    int __cnt = 0;
    while(true)
    {
        ::IceInternal::Handle< ::IceDelegate::Ice::Object> __delBase;
...
::Ice::AsyncResultPtr
IceProxy::Demo::Callback::begin_initiateCallback(const ::Demo::CallbackReceiverPrx& proxy, const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
    ::IceInternal::OutgoingAsyncPtr __result = new ::IceInternal::OutgoingAsync(this, __Demo__Callback__initiateCallback_name, __del, __cookie);
    try
    {
        __result->__prepare(__Demo__Callback__initiateCallback_name, ::Ice::Normal, __ctx);
...
void
IceProxy::Demo::Callback::end_initiateCallback(const ::Ice::AsyncResultPtr& __result)
{
    __end(__result, __Demo__Callback__initiateCallback_name);
}

void
IceProxy::Demo::Callback::shutdown(const ::Ice::Context* __ctx)
{
    ::IceInternal::InvocationObserver __observer(this, __Demo__Callback__shutdown_name, __ctx);
    int __cnt = 0;
    while(true)
    {
        ::IceInternal::Handle< ::IceDelegate::Ice::Object> __delBase;
...
::Ice::AsyncResultPtr
IceProxy::Demo::Callback::begin_shutdown(const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
    ::IceInternal::OutgoingAsyncPtr __result = new ::IceInternal::OutgoingAsync(this, __Demo__Callback__shutdown_name, __del, __cookie);
    try
    {
        __result->__prepare(__Demo__Callback__shutdown_name, ::Ice::Normal, __ctx);
        __result->__writeEmptyParams();
        __result->__send(true);
    }
    catch(const ::Ice::LocalException& __ex)
...
void
IceProxy::Demo::Callback::end_shutdown(const ::Ice::AsyncResultPtr& __result)
{
    __end(__result, __Demo__Callback__shutdown_name);
}
...
void
IceDelegateM::Demo::Callback::initiateCallback(const ::Demo::CallbackReceiverPrx& proxy, const ::Ice::Context* __context, ::IceInternal::InvocationObserver& __observer)
{
    ::IceInternal::Outgoing __og(__handler.get(), __Demo__Callback__initiateCallback_name, ::Ice::Normal, __context, __observer);
    try
    {
...
void
IceDelegateM::Demo::Callback::shutdown(const ::Ice::Context* __context, ::IceInternal::InvocationObserver& __observer)
{
    ::IceInternal::Outgoing __og(__handler.get(), __Demo__Callback__shutdown_name, ::Ice::Normal, __context, __observer);
    __og.writeEmptyParams();
    bool __ok = __og.invoke();
    if(__og.hasResponse())
    {
...
void
IceDelegateD::Demo::Callback::initiateCallback(const ::Demo::CallbackReceiverPrx& proxy, const ::Ice::Context* __context, ::IceInternal::InvocationObserver&)
{
    class _DirectI : public ::IceInternal::Direct
    {
    public:
    ...
    ::Ice::Current __current;
    __initCurrent(__current, __Demo__Callback__initiateCallback_name, ::Ice::Normal, __context);
    try
    {
...
void
IceDelegateD::Demo::Callback::shutdown(const ::Ice::Context* __context, ::IceInternal::InvocationObserver&)
{
    class _DirectI : public ::IceInternal::Direct
    {
    public:
    ...
    ::Ice::Current __current;
    __initCurrent(__current, __Demo__Callback__shutdown_name, ::Ice::Normal, __context);
    try
    {
        _DirectI __direct(__current);
        try
...
::Ice::DispatchStatus
Demo::Callback::___initiateCallback(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    __checkMode(::Ice::Normal, __current.mode);
...
::Ice::DispatchStatus
Demo::Callback::___shutdown(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    __checkMode(::Ice::Normal, __current.mode);
    __inS.readEmptyParams();
    shutdown(__current);
...
{
    ::std::pair< const ::std::string*, const ::std::string*> r = ::std::equal_range(__Demo__Callback_all, __Demo__Callback_all + 6, current.operation);
    if(r.first == r.second)
    {
        throw ::Ice::OperationNotExistException(__FILE__, __LINE__, current.id, current.facet, current.operation);
    }
