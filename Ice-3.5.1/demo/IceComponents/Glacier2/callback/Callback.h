...
public:
    ...
    ::Ice::AsyncResultPtr begin_initiateCallback(const ::Demo::CallbackReceiverPrx& proxy, const ::Demo::Callback_Callback_initiateCallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_initiateCallback(proxy, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_initiateCallback(const ::Demo::CallbackReceiverPrx& proxy, const ::Ice::Context& __ctx, const ::Demo::Callback_Callback_initiateCallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_initiateCallback(proxy, &__ctx, __del, __cookie);
    }
...
public:
    ...
    ::Ice::AsyncResultPtr begin_shutdown(const ::Demo::Callback_Callback_shutdownPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_shutdown(0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_shutdown(const ::Ice::Context& __ctx, const ::Demo::Callback_Callback_shutdownPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_shutdown(&__ctx, __del, __cookie);
    }
