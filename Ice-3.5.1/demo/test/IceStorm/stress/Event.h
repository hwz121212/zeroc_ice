...
public:
    ...
    void pub(::Ice::Int counter)
    {
        pub(counter, 0);
    }
    void pub(::Ice::Int counter, const ::Ice::Context& __ctx)
    {
        pub(counter, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_pub(::Ice::Int counter, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_pub(counter, 0, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent));
    }
    ::Ice::AsyncResultPtr
    begin_pub(::Ice::Int counter, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_pub(counter, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_pub(::Ice::Int counter, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_pub(counter, &__ctx, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_pub(::Ice::Int counter, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_pub(counter, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
#endif

    ::Ice::AsyncResultPtr begin_pub(::Ice::Int counter)
    {
        return begin_pub(counter, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_pub(::Ice::Int counter, const ::Ice::Context& __ctx)
    {
        return begin_pub(counter, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_pub(::Ice::Int counter, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_pub(counter, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_pub(::Ice::Int counter, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_pub(counter, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_pub(::Ice::Int counter, const ::Test::Callback_Event_pubPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_pub(counter, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_pub(::Ice::Int counter, const ::Ice::Context& __ctx, const ::Test::Callback_Event_pubPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_pub(counter, &__ctx, __del, __cookie);
    }
...
private:
    ...
    void pub(::Ice::Int, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_pub(::Ice::Int, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
public:
    ...
    virtual void pub(::Ice::Int, const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;
};
...
public:
    ...
    virtual void pub(::Ice::Int, const ::Ice::Context*, ::IceInternal::InvocationObserver&);
};
...
public:
    ...
    virtual void pub(::Ice::Int, const ::Ice::Current& = ::Ice::Current()) = 0;
