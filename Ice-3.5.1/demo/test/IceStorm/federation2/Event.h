...
class Event;
void __read(::IceInternal::BasicStream*, ::IceInternal::ProxyHandle< ::IceProxy::Test::Event>&);
::IceProxy::Ice::Object* upCast(::IceProxy::Test::Event*);
...
bool operator<(const Event&, const Event&);
::Ice::Object* upCast(::Test::Event*);
typedef ::IceInternal::Handle< ::Test::Event> EventPtr;
...
class Callback_Event_pub_Base : virtual public ::IceInternal::CallbackBase { };
...
public:
    ...
    void pub(const ::std::string& data)
    {
        pub(data, 0);
    }
    void pub(const ::std::string& data, const ::Ice::Context& __ctx)
    {
        pub(data, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_pub(const ::std::string& data, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_pub(data, 0, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent));
    }
    ::Ice::AsyncResultPtr
    begin_pub(const ::std::string& data, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_pub(data, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_pub(const ::std::string& data, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_pub(data, &__ctx, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_pub(const ::std::string& data, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_pub(data, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
#endif

    ::Ice::AsyncResultPtr begin_pub(const ::std::string& data)
    {
        return begin_pub(data, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_pub(const ::std::string& data, const ::Ice::Context& __ctx)
    {
        return begin_pub(data, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_pub(const ::std::string& data, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_pub(data, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_pub(const ::std::string& data, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_pub(data, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_pub(const ::std::string& data, const ::Test::Callback_Event_pubPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_pub(data, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_pub(const ::std::string& data, const ::Ice::Context& __ctx, const ::Test::Callback_Event_pubPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_pub(data, &__ctx, __del, __cookie);
    }

    void end_pub(const ::Ice::AsyncResultPtr&);
    
private:

    void pub(const ::std::string&, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_pub(const ::std::string&, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
public:
    ...
    virtual void pub(const ::std::string&, const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;
};
...
class Event : virtual public ::IceDelegate::Test::Event,
              virtual public ::IceDelegateM::Ice::Object
{
public:

    virtual void pub(const ::std::string&, const ::Ice::Context*, ::IceInternal::InvocationObserver&);
};
...
public:
    ...
    virtual void pub(const ::std::string&, const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___pub(::IceInternal::Incoming&, const ::Ice::Current&);
