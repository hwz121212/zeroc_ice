...
const ::std::string __Test__TestIntf__fail_name = "fail";
...
void
IceProxy::Test::TestIntf::fail(const ::Ice::Context* __ctx)
{
    ::IceInternal::InvocationObserver __observer(this, __Test__TestIntf__fail_name, __ctx);
    int __cnt = 0;
    while(true)
    {
...
::Ice::AsyncResultPtr
IceProxy::Test::TestIntf::begin_fail(const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
    ::IceInternal::OutgoingAsyncPtr __result = new ::IceInternal::OutgoingAsync(this, __Test__TestIntf__fail_name, __del, __cookie);
    try
    {
        __result->__prepare(__Test__TestIntf__fail_name, ::Ice::Normal, __ctx);
...
void
IceProxy::Test::TestIntf::end_fail(const ::Ice::AsyncResultPtr& __result)
{
    __end(__result, __Test__TestIntf__fail_name);
}
...
void
IceDelegateM::Test::TestIntf::fail(const ::Ice::Context* __context, ::IceInternal::InvocationObserver& __observer)
{
    ::IceInternal::Outgoing __og(__handler.get(), __Test__TestIntf__fail_name, ::Ice::Normal, __context, __observer);
...
void
IceDelegateD::Test::TestIntf::fail(const ::Ice::Context* __context, ::IceInternal::InvocationObserver&)
{
    ...
    __initCurrent(__current, __Test__TestIntf__fail_name, ::Ice::Normal, __context);
    try
    {
...
::Ice::DispatchStatus
Test::TestIntf::___fail(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
