...
const ::std::string __Test__B__shutdown_name = "shutdown";
...
void
IceProxy::Test::B::shutdown(const ::Ice::Context* __ctx)
{
    ::IceInternal::InvocationObserver __observer(this, __Test__B__shutdown_name, __ctx);
    int __cnt = 0;
    while(true)
    {
...
::Ice::AsyncResultPtr
IceProxy::Test::B::begin_shutdown(const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
    ::IceInternal::OutgoingAsyncPtr __result = new ::IceInternal::OutgoingAsync(this, __Test__B__shutdown_name, __del, __cookie);
    try
    {
        __result->__prepare(__Test__B__shutdown_name, ::Ice::Normal, __ctx);
...
void
IceProxy::Test::B::end_shutdown(const ::Ice::AsyncResultPtr& __result)
{
    __end(__result, __Test__B__shutdown_name);
}
...
void
IceDelegateM::Test::B::shutdown(const ::Ice::Context* __context, ::IceInternal::InvocationObserver& __observer)
{
    ::IceInternal::Outgoing __og(__handler.get(), __Test__B__shutdown_name, ::Ice::Normal, __context, __observer);
...
void
IceDelegateD::Test::B::shutdown(const ::Ice::Context* __context, ::IceInternal::InvocationObserver&)
{
    ...
    __initCurrent(__current, __Test__B__shutdown_name, ::Ice::Normal, __context);
    try
    {
...
::Ice::DispatchStatus
Test::B::___shutdown(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
