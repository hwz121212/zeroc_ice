...
public:
    ...
    virtual void initiateCallback(const ::Test::CallbackReceiverPrx&, const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___initiateCallback(::IceInternal::Incoming&, const ::Ice::Current&);

    virtual void initiateCallbackEx(const ::Test::CallbackReceiverPrx&, const ::Ice::Current& = ::Ice::Current()) = 0;
