...
public:
    ...
    void callback(::Ice::Int token)
    {
        callback(token, 0);
    }
    void callback(::Ice::Int token, const ::Ice::Context& __ctx)
    {
        callback(token, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_callback(::Ice::Int token, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_callback(token, 0, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent));
    }
    ::Ice::AsyncResultPtr
    begin_callback(::Ice::Int token, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_callback(token, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_callback(::Ice::Int token, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_callback(token, &__ctx, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_callback(::Ice::Int token, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_callback(token, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
#endif

    ::Ice::AsyncResultPtr begin_callback(::Ice::Int token)
    {
        return begin_callback(token, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_callback(::Ice::Int token, const ::Ice::Context& __ctx)
    {
        return begin_callback(token, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_callback(::Ice::Int token, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_callback(token, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_callback(::Ice::Int token, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_callback(token, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_callback(::Ice::Int token, const ::Test::Callback_CallbackReceiver_callbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_callback(token, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_callback(::Ice::Int token, const ::Ice::Context& __ctx, const ::Test::Callback_CallbackReceiver_callbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_callback(token, &__ctx, __del, __cookie);
    }
...
public:
    ...
    void initiateCallback(const ::Test::CallbackReceiverPrx& proxy, ::Ice::Int token)
    {
        initiateCallback(proxy, token, 0);
    }
    void initiateCallback(const ::Test::CallbackReceiverPrx& proxy, ::Ice::Int token, const ::Ice::Context& __ctx)
    {
        initiateCallback(proxy, token, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_initiateCallback(const ::Test::CallbackReceiverPrx& proxy, ::Ice::Int token, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_initiateCallback(proxy, token, 0, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent));
    }
    ::Ice::AsyncResultPtr
    begin_initiateCallback(const ::Test::CallbackReceiverPrx& proxy, ::Ice::Int token, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_initiateCallback(proxy, token, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_initiateCallback(const ::Test::CallbackReceiverPrx& proxy, ::Ice::Int token, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_initiateCallback(proxy, token, &__ctx, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_initiateCallback(const ::Test::CallbackReceiverPrx& proxy, ::Ice::Int token, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_initiateCallback(proxy, token, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
#endif

    ::Ice::AsyncResultPtr begin_initiateCallback(const ::Test::CallbackReceiverPrx& proxy, ::Ice::Int token)
    {
        return begin_initiateCallback(proxy, token, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_initiateCallback(const ::Test::CallbackReceiverPrx& proxy, ::Ice::Int token, const ::Ice::Context& __ctx)
    {
        return begin_initiateCallback(proxy, token, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_initiateCallback(const ::Test::CallbackReceiverPrx& proxy, ::Ice::Int token, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_initiateCallback(proxy, token, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_initiateCallback(const ::Test::CallbackReceiverPrx& proxy, ::Ice::Int token, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_initiateCallback(proxy, token, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_initiateCallback(const ::Test::CallbackReceiverPrx& proxy, ::Ice::Int token, const ::Test::Callback_Callback_initiateCallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_initiateCallback(proxy, token, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_initiateCallback(const ::Test::CallbackReceiverPrx& proxy, ::Ice::Int token, const ::Ice::Context& __ctx, const ::Test::Callback_Callback_initiateCallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_initiateCallback(proxy, token, &__ctx, __del, __cookie);
    }
...
private:
    ...
    void initiateCallback(const ::Test::CallbackReceiverPrx&, ::Ice::Int, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_initiateCallback(const ::Test::CallbackReceiverPrx&, ::Ice::Int, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
public:
    ...
    virtual void initiateCallback(const ::Test::CallbackReceiverPrx&, ::Ice::Int, const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;
...
public:
    ...
    virtual void initiateCallback(const ::Test::CallbackReceiverPrx&, ::Ice::Int, const ::Ice::Context*, ::IceInternal::InvocationObserver&);
...
public:
    ...
    virtual void initiateCallback_async(const ::Test::AMD_Callback_initiateCallbackPtr&, const ::Test::CallbackReceiverPrx&, ::Ice::Int, const ::Ice::Current& = ::Ice::Current()) = 0;
