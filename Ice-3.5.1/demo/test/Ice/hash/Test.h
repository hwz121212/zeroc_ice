...
class Point;
void __read(::IceInternal::BasicStream*, ::IceInternal::ProxyHandle< ::IceProxy::Test::Point>&);
::IceProxy::Ice::Object* upCast(::IceProxy::Test::Point*);
...
bool operator<(const Point&, const Point&);
::Ice::Object* upCast(::Test::Point*);
typedef ::IceInternal::Handle< ::Test::Point> PointPtr;
...
class Point : virtual public ::IceProxy::Ice::Object
{
public:
...
class Point : virtual public ::IceDelegate::Ice::Object
{
public:
};
...
class Point : virtual public ::IceDelegate::Test::Point,
...
class Point : virtual public ::Ice::Object
{
public:
...
protected:
    ...
    friend class Point__staticInit;
};

class Point__staticInit
{
public:
...
static Point__staticInit _Point_init;
