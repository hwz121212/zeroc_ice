...
public:
    ...
    virtual ::std::wstring opString(const ::std::wstring&, ::std::wstring&, const ::Ice::Current& = ::Ice::Current()) = 0;
    ...
    virtual void throwExcept(const ::std::wstring&, const ::Ice::Current& = ::Ice::Current()) = 0;
