...
const ::std::string __Test__TestIntf__abort_name = "abort";

const ::std::string __Test__TestIntf__idempotentAbort_name = "idempotentAbort";

const ::std::string __Test__TestIntf__pid_name = "pid";
...
{
    ::IceInternal::InvocationObserver __observer(this, __Test__TestIntf__abort_name, __ctx);
    int __cnt = 0;
    while(true)
    {
        ::IceInternal::Handle< ::IceDelegate::Ice::Object> __delBase;
...
::Ice::AsyncResultPtr
IceProxy::Test::TestIntf::begin_abort(const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
    ::IceInternal::OutgoingAsyncPtr __result = new ::IceInternal::OutgoingAsync(this, __Test__TestIntf__abort_name, __del, __cookie);
    try
    {
        __result->__prepare(__Test__TestIntf__abort_name, ::Ice::Normal, __ctx);
        __result->__writeEmptyParams();
        __result->__send(true);
    }
    catch(const ::Ice::LocalException& __ex)
...
void
IceProxy::Test::TestIntf::end_abort(const ::Ice::AsyncResultPtr& __result)
{
    __end(__result, __Test__TestIntf__abort_name);
}

void
IceProxy::Test::TestIntf::idempotentAbort(const ::Ice::Context* __ctx)
{
    ::IceInternal::InvocationObserver __observer(this, __Test__TestIntf__idempotentAbort_name, __ctx);
    int __cnt = 0;
    while(true)
    {
        ::IceInternal::Handle< ::IceDelegate::Ice::Object> __delBase;
        try
        {
            __delBase = __getDelegate(false);
            ::IceDelegate::Test::TestIntf* __del = dynamic_cast< ::IceDelegate::Test::TestIntf*>(__delBase.get());
            __del->idempotentAbort(__ctx, __observer);
            return;
        }
        catch(const ::IceInternal::LocalExceptionWrapper& __ex)
        {
...
::Ice::AsyncResultPtr
IceProxy::Test::TestIntf::begin_idempotentAbort(const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
    ::IceInternal::OutgoingAsyncPtr __result = new ::IceInternal::OutgoingAsync(this, __Test__TestIntf__idempotentAbort_name, __del, __cookie);
    try
    {
        __result->__prepare(__Test__TestIntf__idempotentAbort_name, ::Ice::Idempotent, __ctx);
        __result->__writeEmptyParams();
        __result->__send(true);
    }
    catch(const ::Ice::LocalException& __ex)
...
void
IceProxy::Test::TestIntf::end_idempotentAbort(const ::Ice::AsyncResultPtr& __result)
{
    __end(__result, __Test__TestIntf__idempotentAbort_name);
}

::Ice::Int
IceProxy::Test::TestIntf::pid(const ::Ice::Context* __ctx)
{
    ::IceInternal::InvocationObserver __observer(this, __Test__TestIntf__pid_name, __ctx);
    int __cnt = 0;
    while(true)
    {
        ::IceInternal::Handle< ::IceDelegate::Ice::Object> __delBase;
        try
        {
            ...
            __delBase = __getDelegate(false);
            ::IceDelegate::Test::TestIntf* __del = dynamic_cast< ::IceDelegate::Test::TestIntf*>(__delBase.get());
            return __del->pid(__ctx, __observer);
        }
        catch(const ::IceInternal::LocalExceptionWrapper& __ex)
        {
            __handleExceptionWrapperRelaxed(__delBase, __ex, true, __cnt, __observer);
...
::Ice::AsyncResultPtr
IceProxy::Test::TestIntf::begin_pid(const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
    __checkAsyncTwowayOnly(__Test__TestIntf__pid_name);
    ::IceInternal::OutgoingAsyncPtr __result = new ::IceInternal::OutgoingAsync(this, __Test__TestIntf__pid_name, __del, __cookie);
    try
    {
        __result->__prepare(__Test__TestIntf__pid_name, ::Ice::Idempotent, __ctx);
        __result->__writeEmptyParams();
        __result->__send(true);
    }
    catch(const ::Ice::LocalException& __ex)
...
::Ice::Int
IceProxy::Test::TestIntf::end_pid(const ::Ice::AsyncResultPtr& __result)
{
    ::Ice::AsyncResult::__check(__result, this, __Test__TestIntf__pid_name);
    ::Ice::Int __ret;
...
void
IceDelegateM::Test::TestIntf::abort(const ::Ice::Context* __context, ::IceInternal::InvocationObserver& __observer)
{
    ::IceInternal::Outgoing __og(__handler.get(), __Test__TestIntf__abort_name, ::Ice::Normal, __context, __observer);
    __og.writeEmptyParams();
    bool __ok = __og.invoke();
    if(__og.hasResponse())
    {
...
void
IceDelegateM::Test::TestIntf::idempotentAbort(const ::Ice::Context* __context, ::IceInternal::InvocationObserver& __observer)
{
    ::IceInternal::Outgoing __og(__handler.get(), __Test__TestIntf__idempotentAbort_name, ::Ice::Idempotent, __context, __observer);
    __og.writeEmptyParams();
    bool __ok = __og.invoke();
    if(__og.hasResponse())
    {
...
::Ice::Int
IceDelegateM::Test::TestIntf::pid(const ::Ice::Context* __context, ::IceInternal::InvocationObserver& __observer)
{
    ::IceInternal::Outgoing __og(__handler.get(), __Test__TestIntf__pid_name, ::Ice::Idempotent, __context, __observer);
    __og.writeEmptyParams();
    bool __ok = __og.invoke();
    ::Ice::Int __ret;
    try
...
void
IceDelegateD::Test::TestIntf::abort(const ::Ice::Context* __context, ::IceInternal::InvocationObserver&)
{
    class _DirectI : public ::IceInternal::Direct
    {
    public:
    ...
    ::Ice::Current __current;
    __initCurrent(__current, __Test__TestIntf__abort_name, ::Ice::Normal, __context);
    try
    {
        _DirectI __direct(__current);
        try
...
void
IceDelegateD::Test::TestIntf::idempotentAbort(const ::Ice::Context* __context, ::IceInternal::InvocationObserver&)
{
    class _DirectI : public ::IceInternal::Direct
    {
    public:
        ...
        run(::Ice::Object* object)
        {
            ...
            servant->idempotentAbort(_current);
            return ::Ice::DispatchOK;
        }
    ...
    ::Ice::Current __current;
    __initCurrent(__current, __Test__TestIntf__idempotentAbort_name, ::Ice::Idempotent, __context);
    try
    {
        _DirectI __direct(__current);
        try
...
::Ice::Int
IceDelegateD::Test::TestIntf::pid(const ::Ice::Context* __context, ::IceInternal::InvocationObserver&)
{
    class _DirectI : public ::IceInternal::Direct
    {
    public:
    ...
    ::Ice::Current __current;
    __initCurrent(__current, __Test__TestIntf__pid_name, ::Ice::Idempotent, __context);
    ::Ice::Int __result;
    try
    {
