...
private:
    ...
    ::Ice::AsyncResultPtr __begin_createCommunicator(const ::Ice::PropertyDict& props, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::Test::RemoteCommunicatorPrx&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent)
    {
        ...
        public:
            ...
            Cpp11CB(const ::std::function<void (const ::Test::RemoteCommunicatorPrx&)>& responseFunc, const ::std::function<void (const ::Ice::Exception&)>& exceptionFunc, const ::std::function<void (bool)>& sentFunc) :
                ::IceInternal::Cpp11FnCallbackNC(exceptionFunc, sentFunc),
                _response(responseFunc)
            {
                CallbackBase::checkCallback(true, responseFunc || exceptionFunc != nullptr);
        ...
        private:
            ...
            ::std::function<void (const ::Test::RemoteCommunicatorPrx&)> _response;
        };
        return begin_createCommunicator(props, __ctx, new Cpp11CB(__response, __exception, __sent));
    }
...
public:
    ...
    virtual void waitForShutdown(const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;

    virtual void destroy(const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;
};

class RemoteCommunicatorFactory : virtual public ::IceDelegate::Ice::Object
{
public:

    virtual ::Test::RemoteCommunicatorPrx createCommunicator(const ::Ice::PropertyDict&, const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;

    virtual void shutdown(const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;
};

class TestFacet : virtual public ::IceDelegate::Ice::Object
{
public:
...
public:
    ...
    virtual void waitForShutdown(const ::Ice::Context*, ::IceInternal::InvocationObserver&);

    virtual void destroy(const ::Ice::Context*, ::IceInternal::InvocationObserver&);
};

class RemoteCommunicatorFactory : virtual public ::IceDelegate::Test::RemoteCommunicatorFactory,
                                  virtual public ::IceDelegateM::Ice::Object
{
public:

    virtual ::Test::RemoteCommunicatorPrx createCommunicator(const ::Ice::PropertyDict&, const ::Ice::Context*, ::IceInternal::InvocationObserver&);

    virtual void shutdown(const ::Ice::Context*, ::IceInternal::InvocationObserver&);
};

class TestFacet : virtual public ::IceDelegate::Test::TestFacet,
                  virtual public ::IceDelegateM::Ice::Object
{
public:
