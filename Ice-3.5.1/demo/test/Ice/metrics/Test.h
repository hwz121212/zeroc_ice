...
public:
    ...
    virtual void opWithUserException(const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___opWithUserException(::IceInternal::Incoming&, const ::Ice::Current&);

    virtual void opWithRequestFailedException(const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___opWithRequestFailedException(::IceInternal::Incoming&, const ::Ice::Current&);

    virtual void opWithLocalException(const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___opWithLocalException(::IceInternal::Incoming&, const ::Ice::Current&);

    virtual void opWithUnknownException(const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___opWithUnknownException(::IceInternal::Incoming&, const ::Ice::Current&);

    virtual void opByteS(const ::Test::ByteSeq&, const ::Ice::Current& = ::Ice::Current()) = 0;
