...
class Callback_MyObject_getName_Base : virtual public ::IceInternal::CallbackBase { };
...
public:
    ...
    ::Ice::AsyncResultPtr begin_getName(const ::Test::Callback_MyObject_getNamePtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_getName(0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_getName(const ::Ice::Context& __ctx, const ::Test::Callback_MyObject_getNamePtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_getName(&__ctx, __del, __cookie);
    }
