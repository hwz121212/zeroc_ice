...
class AMD_MyClass_getContext : virtual public ::Ice::AMDCallback
{
public:
...
class AMD_MyDerivedClass_echo : virtual public ::Ice::AMDCallback
{
public:
...
class Callback_MyClass_getContext_Base : virtual public ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_MyClass_getContext_Base> Callback_MyClass_getContextPtr;

class Callback_MyDerivedClass_echo_Base : virtual public ::IceInternal::CallbackBase { };
...
public:
    ...
    ::Ice::Context getContext(const ::Ice::Context& __ctx)
    {
        return getContext(&__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_getContext(const ::IceInternal::Function<void (const ::Ice::Context&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_getContext(0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_getContext(const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_getContext(0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_getContext(const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::Context&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_getContext(&__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_getContext(const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_getContext(&__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_getContext(const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::Ice::Context&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent)
    {
        ...
        public:
            ...
            virtual void __completed(const ::Ice::AsyncResultPtr& __result) const
            {
                ...
                try
                {
                    __ret = __proxy->end_getContext(__result);
                }
        ...
        return begin_getContext(__ctx, new Cpp11CB(__response, __exception, __sent));
    }
    
public:
#endif

    ::Ice::AsyncResultPtr begin_getContext()
    {
        return begin_getContext(0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_getContext(const ::Ice::Context& __ctx)
    {
        return begin_getContext(&__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_getContext(const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_getContext(0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_getContext(const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_getContext(&__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_getContext(const ::Test::Callback_MyClass_getContextPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_getContext(0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_getContext(const ::Ice::Context& __ctx, const ::Test::Callback_MyClass_getContextPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_getContext(&__ctx, __del, __cookie);
    }

    ::Ice::Context end_getContext(const ::Ice::AsyncResultPtr&);
    
private:

    ::Ice::Context getContext(const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_getContext(const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_echo(const ::Ice::ObjectPrx& obj, const ::IceInternal::Function<void (const ::Ice::ObjectPrx&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_echo(obj, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_echo(const ::Ice::ObjectPrx& obj, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_echo(obj, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_echo(const ::Ice::ObjectPrx& obj, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::ObjectPrx&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_echo(obj, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_echo(const ::Ice::ObjectPrx& obj, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_echo(obj, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_echo(const ::Ice::ObjectPrx& obj, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::Ice::ObjectPrx&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent)
    {
        class Cpp11CB : public ::IceInternal::Cpp11FnCallbackNC
        {
        public:
            ...
            virtual void __completed(const ::Ice::AsyncResultPtr& __result) const
            {
                ::Test::MyDerivedClassPrx __proxy = ::Test::MyDerivedClassPrx::uncheckedCast(__result->getProxy());
                ::Ice::ObjectPrx __ret;
                try
                {
        ...
        return begin_echo(obj, __ctx, new Cpp11CB(__response, __exception, __sent));
    }
    
public:
#endif

    ::Ice::AsyncResultPtr begin_echo(const ::Ice::ObjectPrx& obj)
    {
        return begin_echo(obj, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_echo(const ::Ice::ObjectPrx& obj, const ::Ice::Context& __ctx)
    {
        return begin_echo(obj, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_echo(const ::Ice::ObjectPrx& obj, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_echo(obj, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_echo(const ::Ice::ObjectPrx& obj, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_echo(obj, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_echo(const ::Ice::ObjectPrx& obj, const ::Test::Callback_MyDerivedClass_echoPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_echo(obj, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_echo(const ::Ice::ObjectPrx& obj, const ::Ice::Context& __ctx, const ::Test::Callback_MyDerivedClass_echoPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_echo(obj, &__ctx, __del, __cookie);
    }

    ::Ice::ObjectPrx end_echo(const ::Ice::AsyncResultPtr&);
    
private:

    ::Ice::ObjectPrx echo(const ::Ice::ObjectPrx&, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_echo(const ::Ice::ObjectPrx&, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
public:
    ...
    virtual ::Ice::Context getContext(const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;
};
...
public:
    ...
    virtual ::Ice::ObjectPrx echo(const ::Ice::ObjectPrx&, const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;
};
...
public:
    ...
    virtual ::Ice::Context getContext(const ::Ice::Context*, ::IceInternal::InvocationObserver&);
};
...
public:
    ...
    virtual ::Ice::ObjectPrx echo(const ::Ice::ObjectPrx&, const ::Ice::Context*, ::IceInternal::InvocationObserver&);
};
...
public:
    ...
    virtual void getContext_async(const ::Test::AMD_MyClass_getContextPtr&, const ::Ice::Current& = ::Ice::Current()) = 0;
...
public:
    ...
    virtual void echo_async(const ::Test::AMD_MyDerivedClass_echoPtr&, const ::Ice::ObjectPrx&, const ::Ice::Current& = ::Ice::Current()) = 0;
